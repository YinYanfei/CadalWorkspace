...
*/		
	...
	{
		File file = new File("E:/index/" + type);
	...
	public boolean readMatrix() {
		...
		try {
			BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("E:/data/matrix.txt"),"UTF-8"));
	...
	public void topTopicGet() {
		...
		//for(int i = 0; i < this.LARGE; ++i) {
		//	System.out.println("********************************");
		//	this.IndexSearch.search(this.topTopic[i]);
		//}
		//
		...
		System.out.println("+++++++++++++++++++++++++++++");
		//for(int i = 0; i < this.LARGE; ++i) {
		//	System.out.println(this.topTopic[i] + "---->" + this.topTopicTmp[i]);
		//}

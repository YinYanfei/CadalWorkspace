...
import ca.pfv.spmf.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth;
...
public class MainTestFPGrowth_strings_saveToFile {
	...
	public static void main(String [] arg) throws FileNotFoundException, IOException{
		...
		String input = fileToPath("contextTransactionDB_strings.txt");  // the database

...
/**
 * This class represents the TF table of frequent itemsets, used by Zart
 *
...
public class TFTableFrequent {
	...
	// At position i, there are the list of frequent itemsets of size i
	...
	// indicate if the frequent itemsets are closed

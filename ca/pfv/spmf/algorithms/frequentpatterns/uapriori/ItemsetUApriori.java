...
public class ItemsetUApriori{
	 ...
	 * @return true, if yes, otherwise, false
	 */
	public boolean isLexicallySmallerthan(ItemsetUApriori itemset2){
	 ...
	 * @return the copy
	 */
	public ItemsetUApriori cloneItemSetMinusOneItem(ItemUApriori itemToExclude){
	...
	* */
	public ItemUApriori allTheSameExceptLastItem(ItemsetUApriori itemset2) {
	 ...
	 */
	public void setItems(List<ItemUApriori> items) {
		this.items = items;
	}
}

...
/**
 * This class is used by the Fournier08 algorithm. 
 * It represents, based on Hirate & Yamana
 * a pair of an (1) Item  and (2) a time interval. 
 * It is used for calculating the support
 * of items in a database. It contains some other information too that 
 * are needed by BIDE/PrefixSpan such as if the item was in an itemset 
 * that is a prefix (cut at right)
 * , if the item was in an itemset that is a postfix (cut a left).
 *

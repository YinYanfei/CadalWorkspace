...
/**
 * Implementation of the K-means algorithm of J. MacQueen (1967) so 
 * that it is integrated with the Fournier-Viger-2008 algorithm for
 * sequential pattern mining.
 * 
 * This implementation should only be used for the Fournier-Viger 2008 
 * algorithm.
 * It clusters only items that are associated with a single double value.
 * 

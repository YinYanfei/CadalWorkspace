...
/**
 * This algorithm is designed to be used with the Fournier-Viger-2008 algorithm.
 * It adds to K-Means the notion of minimum support. 
 * 
 ...
 * than the minimum support (as an integer).
...
public class AlgoKMeansWithSupport{
	 ...
	 */
	public AlgoKMeansWithSupport(int maxK, int relativeMinsup, AlgoKMeans algoKMeans, int numberOfTriesForEachK){
		// save the parameters
		this.maxK = maxK;
	 ...
	 *    be executed for each value of k.
	 */
	public AlgoKMeansWithSupport(int maxK, double minsup, int transactioncount,  AlgoKMeans algoKMeans, int numberOfTriesForEachK){
		this.maxK = maxK;

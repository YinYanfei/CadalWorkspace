...
public class IndexSearch {
	...
	public boolean readFileArrQueryIndex() {
		...
		//
		try{
			BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:/data/query/queryindex.txt"),"UTF-8"));
	...
	public boolean readFileArrQueryTopic(int num) {
		...
		//
		try{
			BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:/data/topic/querytopic"+ num +".txt"),"UTF-8"));
	...
	public boolean readFileArrTimes() {
		...
		//
		try{
			BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("C:/data/query/times.txt"),"UTF-8"));

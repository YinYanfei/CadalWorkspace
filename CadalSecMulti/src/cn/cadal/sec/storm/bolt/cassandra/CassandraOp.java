...
public class CassandraOp {
	...
	public int InsertRecordMinute2(String str) {		
		...
		String PAGENO = strList[3];		// 00000028 [或28]
		String TIME = strList[4];		// 2013-03-13 08:51:671[或更精确]
...
//			}
	...
	public static void main(String[] args) {
		// Test
//		String strTmp = "290.15.6.200$Yanfei$07018720$00000180$2013-03-13 22:07:02.909009";
...
//		co.InsertRecordMinute(strTmp);
		...
		// Query from cf [RecordMinute]
		co.QueryRecordMinute("2013-03-15 18:49");
	}

...
public class OpStep9 {
	private FileReadOp fileReadOp = null;
	private Map<String, String> mapFile10 = null;
	
	public OpStep9() {
		this.fileReadOp = new FileReadOp();
		this.mapFile10 = this.fileReadOp.readFile_10();
	}
	 ...
	 * @param Datfst
	 * @return
	 * 		"0.2691, ,3.4676,6.944675,12601832409.60 ,0.841109,0.903907"
	 */
	public String dealSingleStock(String Stkcd, String Datfst) {
		...
		try{
			...
			for(int idx = 0; idx < 20; idx++) {
				...
				if(this.mapFile10.containsKey(key)){
					return this.mapFile10.get(key);
				}
	 ...
	 * @param stockInfo
	 * @return
	 * 		<"0000012013-05-21", "0.2691, ,3.4676,6.944675,12601832409.60 ,0.841109,0.903907">,<...>,...
	 */

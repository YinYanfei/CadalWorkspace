...
public class OpStep7 {
	private FileReadOp fileReadOp = null;
	private Map<String, String> mapFile8 = null;
	
	public OpStep7() {
		this.fileReadOp = new FileReadOp();
		this.mapFile8 = this.fileReadOp.readFile_8();
	}
	...
	public String dealSingleStock(String Stkcd, String Datfst) {
		...
		try{
			...
			for(int idx = 0; idx < 20; idx++) {
				...
				if(this.mapFile8.containsKey(key)){
					return this.mapFile8.get(key);
				}

...
public class OpStep11 {
	private FileReadOp fileReadOp = null;
	private Map<String, String> mapFile12 = null;
	
	public OpStep11() {
		this.fileReadOp = new FileReadOp();
		this.mapFile12 = this.fileReadOp.readFile_12();
	}
	 ...
	 * @param Datfst
	 * @return
	 * 		"0.965431,27.927885,16.337345,28.927885"
	 */
	public String dealSingleStock(String Stkcd, String Datfst) {
		...
		try{
			...
			for(int idx = 0; idx < 20; idx++) {
				...
				if(this.mapFile12.containsKey(key)){
					return this.mapFile12.get(key);
				}
	 ...
	 * @param stockInfo
	 * @return
	 * 		<"0000012013-05-21", "0.965431,27.927885,16.337345,28.927885">,<...>,...
	 */

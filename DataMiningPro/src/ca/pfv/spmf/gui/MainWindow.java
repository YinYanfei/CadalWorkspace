...
//	 * They are generated automatically by the Visual Editor plugin
//	 * of Eclipse.
//	 */
//	
...
//
//	/**
//	 * Method to launch the software. If there are command line arguments,
//	 * it means that the software is launched from the command line. Otherwise,
//	 * this method launches the graphical user interface.
//	 * 
//	 * @param args command line arguments.
//	 */
//	public static void main(String[] args) {
////		args = new String[]{"run", "K-Means", "C:\\Users\\ph\\Desktop\\Test files\\configKmeans.txt", "output.txt",  "3", "0.4""0.4"};
//		
...
//	
//	/**
//	 * Method to convert a parameter given as a string to a double.
//	 * For example, convert something like "50%" to 0.5.
//	 * @param value a string
//	 * @return a double
//	 */
//	public static double getParamAsDouble(String value){
//		if(value.contains("%")){
...
//	 * @return an integer
//	 */
//	public static int getParamAsInteger(String value){
//		return Integer.parseInt(value);
//	}
//	
//	/**
//	 * Method to get a parameter as a string.
//	 * Note: this method just return the string taken as parameter.
//	 * @param value a string
//	 * @return a string
//	 */
//	public static String getParamAsString(String value){
//		return value;
//	}
//	
//	/**
//	 * Hide all parameters from the user interface.
//	 * This is used to hide fields when the user change algorithms or
//	 * when the JFrame is first created.
//	 */
...
//	
//	/**
//	 * This method run an algorithm. It is called from the GUI interface or
//	 * when the user run the jar file from the command line.
...
//
//				ca.pfv.spmf.algorithms.sequentialpatterns.fournier2008.SequenceDatabase 
//					database = new ca.pfv.spmf.algorithms.sequentialpatterns.fournier2008.SequenceDatabase();
...
//				
//				// Apply algorithm
//				ca.pfv.spmf.algorithms.sequentialpatterns.fournier2008.AlgoBIDEPlus bideplus = new ca.pfv.spmf.algorithms.sequentialpatterns.fournier2008.AlgoBIDEPlus(minsup);  
...
//				double minsup = getParamAsDouble(parameters[0]);
//				ca.pfv.spmf.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth algo = new ca.pfv.spmf.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth();
//				algo.runAlgorithm(inputFile, outputFile, minsup);
//				algo.printStats();
//			}
...
//				Rules rules = algoAgrawal.runAlgorithm(patterns, minconf, outputFile);
//			}
//			// IGB
...
//				ca.pfv.spmf.algorithms.frequentpatterns.two_phase.UtilityTransactionDatabase database = new ca.pfv.spmf.algorithms.frequentpatterns.two_phase.UtilityTransactionDatabase();
//				database.loadFile(inputFile);
//				
//				// Applying the Two-Phase algorithm
//				AlgoTwoPhase twoPhase = new AlgoTwoPhase();
//				ca.pfv.spmf.algorithms.frequentpatterns.two_phase.Itemsets highUtilityItemsets = twoPhase.runAlgorithm(database, minutil);
//				
...
//	
//	/**
//	 * This method process the command line arguments when
//	 * the spmf.jar file is called from the command line.
//	 * @param args command line arguments.
//	 */

 ...
 * binary context.
 * 
 * Note that the performance of the Hash-Tree version depends on the BRANCH COUNT value
 * in the class ItemsetHashTree.  In my test, I have used a value of 80 because it seems to provide
 * the best results. But other values could be used.
 * 

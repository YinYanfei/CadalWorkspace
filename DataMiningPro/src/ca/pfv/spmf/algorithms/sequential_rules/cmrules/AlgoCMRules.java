 ...
 * 
 * This implementation use a modified AprioriTID algorithm for generating assoc. rules
 * in phase 1.
 *
...
public class AlgoCMRules {
	...
	public int associationRulesCount = 0 ; // number of association rules
	int ruleCount;  // the number of sequential rules generated
	long timeStart = 0; // start time
	long timeEnd = 0; // end time
	public long timeEndConvert = 0;  // end time for conversion to transaction database
	public long timeEndApriori = 0; // end time for calculating frequent itemsets
	public long timeEndSequentialMeasures = 0; // end time for calculating measures for sequential rules
	public long timeBeginCalculateSequentialMeasures = 0;  // start time for calculating measures for sequential rules
	public long timeEndPreprocessing = 0;  // end time for pre-processing
...
//	 a triangular matrix for efficiently counting the support of pairs of items
	 ...
	 * @param input input file containing a sequence database.
	 * @param output the file path for writing the result
	 * @param absoluteMinSupport   the minsup is a number of sequences (ex.: 5 =  5 sequences of the database)
	 * @param minConfidence  the minimum confidence threshold
	 * @throws IOException exception if error while writing the output file.
	 */
...
//		
	 ...
	 */
	public void generateRules(Itemsets patterns) throws IOException {

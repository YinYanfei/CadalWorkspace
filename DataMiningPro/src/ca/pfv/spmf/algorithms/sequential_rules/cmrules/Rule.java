 ...
 */
public class Rule {
	private Itemset itemset1; // antecedent itemset
	private Itemset itemset2; // consequent  itemset
	private int transactionCount; // association support
	 int sequentialTransactionCount;  // sequential support

 ...
 * optimizations such as pseudo-projections. This version is designed for 
 * being used for multi-dimensionnal sequential pattern mining. There is another
 * version for general use that is more optimized
 * 
...
public class AlgoPrefixSpanMDSPM extends AbstractAlgoPrefixSpan {
	...
	private void prefixSpan(SequenceDatabase database){
		...
		// that item.
		Map<Item, Set<Integer>> mapSequenceID = calculateSupportOfItems(database);
	 ...
	 *             containing the item.
	 */
	private Map<Item, Set<Integer>> calculateSupportOfItems(SequenceDatabase database) {

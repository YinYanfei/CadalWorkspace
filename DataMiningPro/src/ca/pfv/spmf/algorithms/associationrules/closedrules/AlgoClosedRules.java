 ...
 * if the user provides a null output file path.
 *
...
public class AlgoClosedRules {
	...
	public Rules runAlgorithm(Itemsets closedItemsets, double minconf, String outputFile) throws IOException {
		this.closedItemsets = closedItemsets;
		
		// if the user want to keep the result into memory
		if(outputFile == null){
			writer = null;
			rules = new Rules("Closed association rules");
	    }else{ 

package cn.cadal.rec.dm.patterns.itemset_array_integers_with_tids;
 ...
 * 	- items are integers
 * 	- the itemset an array of integers sorted by lexical order where no item can appear twice

package cn.cadal.rec.dm.patterns.itemset_set_integers_with_tids;
...
public class Itemset extends AbstractItemset{
	 public Set<Integer> itemset = new HashSet<Integer>(); // the items
	 public Set<Integer> tidset = new HashSet<Integer>(); // the list of transaction/sequence ids containing this itemset

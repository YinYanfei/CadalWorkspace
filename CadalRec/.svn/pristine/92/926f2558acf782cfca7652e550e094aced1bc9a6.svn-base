package cn.cadal.rec.dm.input.sequence_database_array_integers;
...
public class SequenceDatabase {
	...
	public int minItem = Integer.MAX_VALUE; // smallest item in this database
	public int maxItem = 0; // largest item in this database
//	public int tidsCount =0; // the number of sequences in this database
...
//		}
//	}
//	// ---------------------- Pour le fomat gï¿½nï¿½rï¿?par seq_data_generator

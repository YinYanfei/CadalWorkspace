package cn.cadal.rec.dm.tools.dataset_generator;
...
/**
* This class is a random transaction database generator.
* The user provides some parameters and this class generate a transaction database

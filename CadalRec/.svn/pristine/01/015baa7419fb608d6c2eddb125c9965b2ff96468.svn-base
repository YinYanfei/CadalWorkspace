package cn.cadal.rec.dm.patterns.itemset_list_integers_with_count;
...
/**
 * This class represents an itemset (a set of items) - items are integers - the
 * itemset a set of integers sorted by lexical order where no item can appear
 * twice - the number of transactions/sequences containing this itemset is

 ...
 *                   interpreted.
 */
public class MainTestConvertTransactionDatabaseARFFtoSPMF {

	public static void main(String[] arg) throws IOException {

		String inputFile = fileToPath("example.arff");
		String outputFile = "C://patterns//test2.txt";
		Formats inputFileformat = Formats.ARFF;
		int sequenceCount = Integer.MAX_VALUE;

		TransactionDatabaseConverter converter = new TransactionDatabaseConverter();
		converter
				.convert(inputFile, outputFile, inputFileformat, sequenceCount);
	}

package cn.cadal.rec.dm.input.sequence_database_list_strings;
...
/**
 * Implementation of a sequence (a list of itemsets containing strings).
 *
...
public class Sequence{
	...
	private int id; // id of this sequence

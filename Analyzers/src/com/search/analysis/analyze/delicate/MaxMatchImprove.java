...
public class MaxMatchImprove extends Word{
	...
	public static void main(String[] args) {
		...
		/*
		maxMatchImp.setSentence("浙江大学计算机学院的张志坤");
		maxMatchImp.setSentence("分布式全文搜索引擎的研究与实现");
		maxMatchImp.setSentence("毕业设计论文开题报告");
		maxMatchImp.setSentence("金融财务高新技术等企业的信息系统中" +
		 		"数据存储的安全问题敏感数据的防窃取和防篡改问题越" +
		 		"来越引起人们的重视");
		
		maxMatchImp.setSentence("随着计算机网络的发展数据库的安全性" +
		...
		maxMatchImp.setSentence("伴随着各行各业对数据库更加广泛的应" +
		...
		maxMatchImp.setSentence("而网友对于韩红的行为却褒贬不一有人" +
				"支持她的率性也有人认为作为一个公众人物行为不应该" +
				"如此偏激韩红表示我根本不看评论我只痛快我自己");
		*/
		
		maxMatchImp.setSentence("中华人民共和国中央人民政府今天成立了");

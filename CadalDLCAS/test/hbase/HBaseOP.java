		...
		try {
			...
			for (Result r : rs) {
				...
				for (int i = 0; i < kv.length; ++i) {
					byte [] byteKey = kv[i].getRow();
					
					System.out.println(Bytes.toInt(byteKey, 0, 4));
					System.out.println(Bytes.toLong(byteKey, 4, 8));
					System.out.println(Bytes.toLong(byteKey, 12, 8));
					System.out.println(Bytes.toString(byteKey, 20, 32));
					System.out.println("====");
					
					System.out.println(new String(kv[i].getFamily()) + "  ");
					System.out.println(new String(kv[i].getQualifier()) + "  ");
					System.out.println(kv[i].getTimestamp());
					if(new String(kv[i].getQualifier()).equals("time")){
						System.out.println(Bytes.toLong(kv[i].getValue()));	
					}else{

...
/**
 * 接收用户阅读书页的消息, 连接Kafka的Consumer与Storm的Spout,Kafka topic为：Read-common
 * 消息的字段为：ip  user  bookid  pageno  time
 * 
 */
public class ReadInfoSpout extends BaseRichSpout {
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields("read_common"));

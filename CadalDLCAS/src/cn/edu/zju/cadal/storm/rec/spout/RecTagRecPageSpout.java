 ...
 * 
 * 发送给Bolt的消息：
 * 		ip#$#user#$#tag#$#time#$#source
 * 
 * @author CADAL
 */
public class RecTagRecPageSpout extends BaseRichSpout {
	...
	public void nextTuple() {
		if(it.hasNext()) {
			String emitvalue = (new String(it.next().message())) + "#$#" + "recPage";
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields("recTagRecPage"));
	}

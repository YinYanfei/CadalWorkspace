 ...
 * @author CADAL
 */
public class RecBookHomePageSpout extends BaseRichSpout{
	...
	public void nextTuple() {
		if(it.hasNext()) {
			String emitvalue = (new String(it.next().message())) + "#$#" + "homePage";
	...
	public void declareOutputFields(OutputFieldsDeclarer declarer) {
		declarer.declare(new Fields("recBookHomePage"));
	}

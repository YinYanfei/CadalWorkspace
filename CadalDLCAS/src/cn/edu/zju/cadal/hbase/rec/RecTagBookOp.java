...
public class RecTagBookOp {
	...
	public RecTagBookOp() {
		...
		this.htable = this.handler.HTableHandler(HBaseTable.REC_TAG_BOOK);
		this.cf = Bytes.toBytes("tag_book");
	...
	/**
	 * Insert single row into table HBaseTable.REC_TAG_BOOK
	 * 
	 * @param ip
	 * @param user
	 * @param tagname
	 ...
	 * @return
	 */
	public boolean insertSingleRow(String ip, String user, String tagname, String bookid, long timestamp) {
		try {
	 ...
	 *        [
	 *            [
	 *            'ip':'10.15.62.75','user':'Yanfei','tagname':'�㽭','bookid':'07018720','time':'1234567890'
	 *            ],
	 *            [
	 *            'ip':'10.15.62.75','user':'Yanfei','tagname':'�㽭','bookid':'07018720','time':'1234567890'
	 *            ],
	...
	public static void main(String[] args) {
		// TEST
		RecTagBookOp recTagBook = new RecTagBookOp();
		recTagBook.Scanner("2000-01-01 00:00:00", "2013-12-31 23:59:59","C:\\Users\\hongxin\\Desktop\\test.out");
//		recTagBook.insertSingleRow("10.15.62.121", "Yanfei", "�㽭", "07018720", System.currentTimeMillis());
	}
}

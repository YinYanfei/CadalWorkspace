...
public class RecUserOp {
	...
	public RecUserOp() {
		...
		this.htable = this.handler.HTableHandler(HBaseTable.REC_USER);
		this.cf = Bytes.toBytes("user");
	...
	/**
	 * Insert single row into table HBaseTable.REC_USER
	 * 
	 * @param ip
	 * @param user
	 * @param user_r
	 ...
	 * @return
	 */
	public boolean insertSingleRow(String ip, String user, String user_r, String source, long timestamp) {
		try {
	 ...
	 *        [
	 *            [
	 *            'ip':'10.15.62.75','user':'Yanfei','user_r':'zju','source':'HomePage','time':'1234567890'
	 *            ],
	 *            [
	 *            'ip':'10.15.62.75','user':'Yanfei','user_r':'zju','source':'HomePage','time':'1234567890'
	 *            ],
	...
	public static void main(String[] args) {
		// TEST
		RecUserOp recUser = new RecUserOp();
		recUser.Scanner("2000-01-01 00:00:00", "2013-12-03 21:00:00","C:\\Users\\hongxin\\Desktop\\test.out");
	//	recUser.insertSingleRow("10.15.62.121", "Yanfei", "zju", "HomePage", System.currentTimeMillis());
	}
